...
class MeioUploadBehavior extends ModelBehavior {
	...
	var $default_options = array(
		...
		'validations' => array(
			'FieldName' => array(
				...
				'check' => true,
				'message' => 'This field has not been defined between the parameters MeioUploadBehavior.'
			),
			'Dir' => array(
				'rule' => array('uploadCheckDir'),
				'check' => true,
				'message' => 'The directory where this file would be placed not exist or is write protected.'
			),
			'Empty' => array(
			...
			'UploadError' => array(
				...
				'check' => true,
				'message' => 'Problems occurred in the file upload.'
			),
			'MaxSize' => array(
	 ...
	 * @param $data Array
	 */
	function uploadCheckFieldName(Model $model, $data,$other){
	 ...
	 * @param $data Array
	 */
	function uploadCheckDir(Model $model, $data){
		foreach($data as $fieldName => $field){
	 ...
	 * @param $data Array
	 */
	function uploadCheckEmpty(Model $model, $data){
		foreach($data as $fieldName => $field){
	 ...
	 * @param $data Array
	 */
	function uploadCheckUploadError(Model $model, $data){
		foreach($data as $fieldName => $field){
	 ...
	 * @param $data Array
	 */
	function uploadCheckMaxSize(Model $model, $data){
		foreach($data as $fieldName => $field){
	 ...
	 * @param $data Array
	 */
	function uploadCheckInvalidMime(Model $model, $data){
		foreach($data as $fieldName => $field){
	 ...
	 * @param $data Array
	 */
	function uploadCheckInvalidExt(Model $model, $data){
		foreach($data as $fieldName => $field){
