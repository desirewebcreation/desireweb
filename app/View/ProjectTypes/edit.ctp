...
echo $this->Form->create('ProjectType', array(
...
<div class="col-lg-6 col-sm-6"><h3><?php echo __('Edit Project Type'); ?></h3> </div> </div>
<?php //echo $this->Form->create('ProjectType'); ?>
	<fieldset>
		<legend><?php //echo __('Edit Project Type'); ?></legend>
	<?php
