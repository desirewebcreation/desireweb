...
<div class="container">
	...
	<div class="col-lg-12 filter"
		...
		<div class="row">
			...
			<div class="col-lg-12">
         <?php echo $this->Form->create('Lead', array('class' => 'form-horizontal','action' => 'index', 'controller'=>'Lead','type' => 'get') );?>
         </div>
            <?php           
...
<div class="lead <?php if($i%2==0) echo "even_row" ?>">
			...
			<?php echo $this->Form->postLink('<i class="fa fa-times"></i>', array('action' => 'delete', $lead['Lead']['id']),array('escape'=>false), __('Are you sure you want to delete # %s?', $lead['Lead']['id'])); ?></span>
				...
				<div class="quickEdit<?php echo $i;?> quickEdit"
					style="display: none;">
		   ...
		   <?php	echo $this->Form->create('Lead',array('class' => 'form-horizontal','url'=>array('controller'=>'Leads', 'action'=>'quickEditLead',$lead['Lead']['id'] ))); ?>
