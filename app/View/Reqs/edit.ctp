...
echo $this->Form->create('Req', array(
...
<div class="col-lg-6 col-sm-6"><h3><?php echo __('Edit Req'); ?></h3> </div> </div>
<?php //echo $this->Form->create('Req'); ?>
	<fieldset>
		<legend><?php //echo __('Edit Req'); ?></legend>
	<?php
...
<?php /*?><div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Req.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Req.id'))); ?></li>
